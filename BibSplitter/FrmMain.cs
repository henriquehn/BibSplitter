...
namespace BibSplitter
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        File.WriteAllText(Path.Combine(dst, $"{group.Key ?? "sem_ano"}.bib"), BibConverter<BibElement, BibElements, BibElementAdapter>.Serialize(group), Encoding.UTF8);
            //    }
            //}
            //catch (Exception ex)
            //{
